...
<head>
    ...
    <title>{{ __('lang.reset_password') }} — Mosaico</title>
</head>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px;background:var(--cream);background-image:radial-gradient(ellipse 80% 60% at 20% 10%, rgba(179,74,50,0.04) 0%, transparent 60%);">
    <div style="background:#fff;border-radius:16px;padding:44px 48px;max-width:420px;width:100%;box-shadow:0 16px 48px rgba(0,0,0,0.1);border:1px solid var(--border);">
        <div style="text-align:center;margin-bottom:32px;">
            ...
            <h2 style="font-family:var(--font-serif);font-size:1.5rem;font-weight:400;color:var(--ink);margin:0 0 4px;">{{ __('lang.reset_password') }}</h2>
            ...
            <p style="font-size:0.8rem;color:var(--ink-lt);margin:0;">{{ __('lang.reset_password_desc') }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div style="margin-bottom:18px;">
                <label style="font-size:0.7rem;font-weight:600;text-transform:uppercase;letter-spacing:.08em;color:var(--ink-lt);display:block;margin-bottom:6px;">{{ __('lang.new_password') }}</label>
            ...
            <div style="margin-bottom:28px;">
                <label style="font-size:0.7rem;font-weight:600;text-transform:uppercase;letter-spacing:.08em;color:var(--ink-lt);display:block;margin-bottom:6px;">{{ __('lang.confirm_password') }}</label>
        ...
        <div style="text-align:center;margin-top:24px;">
            <a href="{{ route('login') }}" style="font-size:0.8rem;color:var(--terra);text-decoration:none;font-weight:500;">← {{ __('lang.back_to_login') }}</a>
        </div>
    </div>
</div>
